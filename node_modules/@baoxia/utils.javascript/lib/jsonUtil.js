...
export class JsonUtil {
     ...
     */
    static parseOrConvertValue(jsonOrObject) {
        ...
        let propertyInfesNeedConvertDateTimeProperty = new Array();
        ObjectUtil.enumerateAllPropertiesOf(jsonOrObject, (propertyOwnerName, propertyOwner, propertyName, propertyValue) => {
            if (propertyName.endsWith(JsonUtilPropertyNameSuffixKeyword.DateTime)) {
                propertyInfesNeedConvertDateTimeProperty.push(new ObjectPropertyInfo(propertyOwner, propertyName, propertyValue));
            }
        });
        for (var propertyInfoNeedConvertDateTimeProperty of propertyInfesNeedConvertDateTimeProperty) {
