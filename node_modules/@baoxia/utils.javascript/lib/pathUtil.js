...
export class PathUtil {
     ...
     */
    static toDirectoryPathFromFilePath(fileDirectoryPath) {
     ...
     */
    static getFileNameFromFilePath(filePath, isIncludeFileExtensionName = true, isLastFileExtensionName = true) {
        ...
        let pathDelimiter = FilePathDelimiter.PathDelimiter;
        let lastPathDelimiterIndex = StringUtil.lastIndexOfKeywordIn(filePath, pathDelimiter);
        if (lastPathDelimiterIndex >= 0) {
            fileName = filePath.substring(lastPathDelimiterIndex + 1);
            let uriQueryAndFragmentInFileName = UriUtil.getUriQueryAndFragmentFrom(fileName);
            if (uriQueryAndFragmentInFileName != null) {
                fileName = fileName.substring(0, uriQueryAndFragmentInFileName.beginCharIndex);
            }
            if (!isIncludeFileExtensionName) {
                let fileExtensionNameDelimiterIndex = isLastFileExtensionName
                    ? StringUtil.lastIndexOfKeywordIn(fileName, FilePathDelimiter.FileExtensionNameDelimiter)
                    : StringUtil.indexOfKeywordIn(fileName, FilePathDelimiter.FileExtensionNameDelimiter);
     ...
     */
    static getFileExtensionNameFromFilePath(filePath, isGetLastFileExtensionName = true) {
        let fileName = PathUtil.getFileNameFromFilePath(filePath, true);
        let fileExtensionName = StringUtil.Empty;
        let fileExtensionNameDelimiterIndex = isGetLastFileExtensionName
            ? StringUtil.lastIndexOfKeywordIn(fileName, FilePathDelimiter.FileExtensionNameDelimiter)
            : StringUtil.indexOfKeywordIn(fileName, FilePathDelimiter.FileExtensionNameDelimiter);
        if (fileExtensionNameDelimiterIndex >= 0) {
     ...
     */
    static toDirectoryPathFromUriPath(uriDirectoryPath) {
     ...
     */
    static getFileNameFromUriPath(uriPath, isIncludeFileExtensionName = true, isLastFileExtensionName = true) {
        ...
        let fileName = StringUtil.Empty;
        let pathDelimiter = UriPathDelimiter.Paths;
        let lastPathDelimiterIndex = StringUtil.lastIndexOfKeywordIn(uriPath, pathDelimiter);
        if (lastPathDelimiterIndex >= 0) {
     ...
     */
    static getFileExtensionNameFromUriPath(uriPath, isGetLastFileExtensionName = true) {
        let fileName = PathUtil.getFileNameFromUriPath(uriPath, true);
        let fileExtensionName = StringUtil.Empty;
        let fileExtensionNameDelimiterIndex = isGetLastFileExtensionName
            ? StringUtil.lastIndexOfKeywordIn(fileName, FilePathDelimiter.FileExtensionNameDelimiter)
            : StringUtil.indexOfKeywordIn(fileName, FilePathDelimiter.FileExtensionNameDelimiter);
