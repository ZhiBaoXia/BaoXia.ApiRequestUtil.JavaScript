export class ArrayUtil {
     ...
     */
    static enumerateItemInItemArraysTo(toReceiveItems, ...itemArrays) {
        if (ArrayUtil.isEmpty(itemArrays)) {
            return;
        }
        let itemArraysCount = itemArrays.length;
        let allItemCombinationsCount = 0;
        let itemArrayCurrentItemIndexes = new Array();
        let itemArrayCurrentItems = new Array();
        ...
        for (let itemIndex = 0; itemIndex < allItemCombinationsCount; itemIndex++) {
            ////////////////////////////////////////////////
            // 1/2，更新各个数组的当前元素索引值：
            ////////////////////////////////////////////////
            for (let itemArrayIndex = 0; itemArrayIndex < itemArraysCount; itemArrayIndex++) {
