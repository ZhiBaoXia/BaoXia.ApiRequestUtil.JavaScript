...
export class Uri {
    ...
    set absoluteUri(absoluteUri) {
        ...
        if (hostPortDelimiterIndex > -1) {
            ...
            this.port = StringUtil.parseToInt(host.substring(hostPortDelimiterIndex + UriPathDelimiter.HostToPort.length));
        }
        else {
            this.host = host;
        }
        ...
        if (pathQueryDelimiter == UriPathDelimiter.PathToQuery) {
            ...
            if (queryFragmentDelimiterIndex > -1) {
                ...
                let fragmentBeginIndex = queryFragmentDelimiterIndex
    ...
    set fragment(fragment) {
        if (StringUtil.isEquals(this._fragment, fragment, false, true)) {
            return;
        }
        ...
        fragment = fragment;
        let fragmentParameters = new Map();
